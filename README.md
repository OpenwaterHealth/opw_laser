...
## Lasr Charactterization and Qualificatiaon - wiki:
This document contains the information regarding the laser system used in Openwater bloodflow monitoring units. It explains the requirements for the laser systems, discusses the techincal issues, the tests and characterizations performed at Openwater lab to qualify the laser system.
